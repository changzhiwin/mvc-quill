...
case class QuestionEntity(id: Long, text: String, possibleAnswer: Set[PossibleAnswerEntity])
...
object QuestionEntity {
  ...
  def fromRecord(question: Question, answers: Seq[Answer]): QuestionEntity = {
